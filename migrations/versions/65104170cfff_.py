...
Revision ID: 65104170cfff
Revises: 
Create Date: 2024-09-25 04:07:14.970998
...
def upgrade():
    ...
    sa.Column('host_username', sa.String(length=80), nullable=False),
    sa.Column('host_profile_image', sa.String(length=200), nullable=True),
